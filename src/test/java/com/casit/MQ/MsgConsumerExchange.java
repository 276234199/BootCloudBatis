...
public class MsgConsumerExchange {
...
//		String queueName = "rua";
//		channel.queueDeclare(queueName, durable, false, autoDelete, null);
		channel.queueBind(queueName, EXCHANGE_NAME, "");

		System.out.println("MsgExchangeConsumer [*] Waiting for messages.");
		...
		Consumer consumer = new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties,
				...
				System.out.println("MsgExchangeConsumer [x] Received '" + message + "'");
