...
public class MsgConsumerRoutingExchange2 {

	private final static String Routing_EXCHANGE_NAME = "routing_exchange";

	private final static String Routing = "Routing2";
	...
	public static void main(String[] args) throws IOException, TimeoutException {
		...
		System.out.println(" Routing_EXCHANGE2 [*] Waiting for messages");
		...
		Consumer consumer = new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties,
				...
				System.out.println("Routing_EXCHANGE2 [x] Received '" + message + "'");
