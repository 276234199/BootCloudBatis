...
public class MsgConsumerTopicsExchange2 {

	private final static String Topics_EXCHANGE_NAME = "topics_exchange";

	private final static String TopicsBindingKey = "#.key4.#";
	...
	public static void main(String argsp[]) throws IOException, TimeoutException {
		...
		System.out.println(" Topics_EXCHANGE2 [*] Waiting for messages");
		...
		Consumer consumer = new DefaultConsumer(channel) {
			...
			public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties,
				...
				System.out.println("Topics_EXCHANGE2 [x] Received '" + message + "'");
